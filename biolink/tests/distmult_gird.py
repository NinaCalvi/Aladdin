...
def to_logfile(c, path):
    outfile = "{}/dist_covid{}.log".format(path, summary(c).replace("/", "_"))
    return outfile
...
def main(argv):
    ...
    path = '/home/acalvi/Dissertation/Aladdin/dist_covid'
    is_rc = False
